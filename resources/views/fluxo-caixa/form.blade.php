    ...
    <div class="card-body">
        <form method="POST" action="{{ $movimentacao ? route('fluxo-caixa.update', $movimentacao['id']) : route('fluxo-caixa.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-bottom: 1.5rem;">
               <label for="nota_fiscal" style="display: block; font-weight: 500; margin-bottom: 0.5rem;">
                   Anexar Nota Fiscal / Comprovante (PDF, PNG, JPG)
               </label>
               ...
               <small class="text-muted">
                   Selecione um arquivo PDF, PNG ou JPG.
               </small>
            </div>          
